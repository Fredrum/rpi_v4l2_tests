...
I ended up using glfw as that seemed to allow for getting a gl window thrown up with minimal amount of code. There were a few tricks to getting this to work which I will describe below.
